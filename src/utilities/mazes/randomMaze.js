export function randomMaze(grid, start, end) {
    ...
    console.log(randomMazeUtil(grid, 0, 0, width, height, chooseOrientation(width, height), walls));

    function randomMazeUtil(grid, x, y, width, height, orientation, walls) {
        if (width < 2 || height < 2)
            return grid, walls
        ...
        randomMazeUtil(grid, nx, ny, w, h, chooseOrientation(w, h), walls);
